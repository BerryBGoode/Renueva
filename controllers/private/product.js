...
async function loadTable(form = null) {
    // verificar si form tiene valor para determinar acción 'load' or 'search'
    (form) ? action = 'search' : action = 'loadTable';
    // obtener las respuestas del servidor
    const JSON = await dataRequest(PRODUCT, action, form);
